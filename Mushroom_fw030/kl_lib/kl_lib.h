...
public:
    ...
    void Setup(BitOrder_t BitOrder, CPOL_t CPOL, CPHA_t CPHA,
        ...
        if     (BitNumber == bitn8)  PSpi->CR2 = (uint16_t)0b0111 << 8;
        else if(BitNumber == bitn16) PSpi->CR2 = (uint16_t)0b1111 << 8;
...
public:
    ...
    uint8_t SetupPLLDividers(uint8_t HsePreDiv, PllMul_t PllMul, PllSrc_t Src);
    void UpdateFreqValues();
